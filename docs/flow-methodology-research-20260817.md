...
2026-08-17在GitHub Actions上实际跑通该外部回归：本站按交易所份额变化×同日NAV重算的股票ETF（含跨境）为 **-242.07亿元**，与iFinD公开 **-243.75亿元** 相差1.68亿元、约0.69%；单ETF方面，159915本站-53.83亿元 vs 公开-54.90亿元，588000本站-42.57亿元 vs 公开-43.94亿元，515880本站-18.33亿元 vs 公开-18.92亿元。该结果说明当前份额时点与NAV估值链条可以在已知公开日期上复现主流资讯口径，误差处于约1%—3%的量级，而不是系统性少算数倍。Wind同日按成交均价统计股票ETF（含跨境）为-250.50亿元，与NAV口径存在正常估值差异。
