...
class FlowModelV2Tests(unittest.TestCase):
    ...
    def test_new_a_share_etf_enters_one_day_scope_without_waiting_for_20_day_history(self):
        ...
        snapshot["universe"].append({
            "code": "159999", "name": "全新策略指数ETF", "shares": 220_000_000,
            "groupId": "other_a_share_stock_etf", "groupName": "其他A股股票ETF", "kind": "other",
            "referencePrice": 1.0, "referencePriceType": "NAV",
        })
        ths = pd.concat([self._ths(), pd.DataFrame([{
            "code": "159999", "fund_name": "全新策略指数ETF", "nav": 1.0,
            "prev_nav": 1.0, "fund_type": "股票型",
        }])], ignore_index=True)
        window = [
