...
`.github/workflows/daily-etf-data.yml` 在交易日北京时间 23:10、23:50、次日00:30 优先检查当日完整的交易所份额/NAV数据；若未通过则在次日05:00—08:00兜底重试。只有官方份额、净值与全部质量校验通过，才运行 `update_daily_v2.py` 发布一级市场净申购/赎回、范围对账和行业主题汇总。
