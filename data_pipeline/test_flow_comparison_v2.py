...
class FlowComparisonV2Tests(unittest.TestCase):
    def test_scope_comparisons_use_same_share_delta_not_a_second_flow_event(self):
        snapshot = {
            "universe": [
                {"code": "510300", "assetScope": "aShareStockEtf", "shareDelta1d": 100_000_000,
                 "primaryFlow1d": 5.0, "referencePrice": 4.9},
                {"code": "513100", "assetScope": "crossBorderStockEtf", "shareDelta1d": -200_000_000,
                 "primaryFlow1d": -4.2, "referencePrice": 2.0},
                {"code": "511010", "assetScope": "bondEtf", "shareDelta1d": 10_000_000,
                 "primaryFlow1d": 10.1, "referencePrice": 100.0},
                # No canonical NAV metric -> excluded from alternate valuation too.
                {"code": "510999", "assetScope": "aShareStockEtf", "shareDelta1d": 500_000_000,
                 "primaryFlow1d": None, "referencePrice": 1.0},
            ],
        ...
        self.assertEqual(values["samplePolicy"], "same_etfs_as_canonical_nav_metric")
