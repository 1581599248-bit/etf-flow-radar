...
class UpdateDailyV2Tests(unittest.TestCase):
    ...
    def test_market_flow_headline_covers_strength_direction_and_divergence(self):
        cases = [
            (
                ...
                "A股ETF盘中买盘偏强，主动买入净额94.5亿元；但ETF份额对应资金大幅净流出185.7亿元，盘面买盘虽强，份额端却在逢高兑现，有资金借反弹离场。",
            ),
            (
                20.0, 20.0, 2000.0, 20000.0,
                "A股ETF盘中买盘小幅偏强，主动买入净额20.0亿元；ETF份额对应资金小幅净流入20.0亿元，盘面买盘与份额申购同向发力，资金进场意愿明确。",
            ),
            (
                150.0, 120.0, 2000.0, 20000.0,
                "A股ETF盘中买盘明显占优，主动买入净额150.0亿元；ETF份额对应资金大幅净流入120.0亿元，盘面买盘与份额申购同向发力，资金进场意愿明确。",
            ),
            (
                -150.0, -120.0, 2000.0, 20000.0,
                "A股ETF盘中卖盘明显占优，主动卖出净额150.0亿元；ETF份额对应资金大幅净流出120.0亿元，盘面抛压与份额赎回共振，资金离场方向一致。",
            ),
            (
                -80.0, 80.0, 2000.0, 20000.0,
                "A股ETF盘中卖盘偏强，主动卖出净额80.0亿元；但ETF份额对应资金明显净流入80.0亿元，盘面抛压虽重，大资金却在逢跌进场，一级市场承接有力。",
            ),
            (
                10.0, -120.0, 2000.0, 20000.0,
                "A股ETF盘中买卖力量基本均衡；ETF份额对应资金大幅净流出120.0亿元，盘面交易相对平稳，份额端资金却在持续撤离。",
            ),
            (
                80.0, 5.0, 2000.0, 20000.0,
                "A股ETF盘中买盘偏强，主动买入净额80.0亿元；ETF份额对应资金基本持平，盘面买盘活跃，但份额申赎按兵不动，仍属存量博弈。",
            ),
            (
    ...
    def test_homepage_headline_uses_strength_copy_and_visible_sector_layer(self):
        ...
        self.assertTrue(headline.startswith("A股ETF盘中买盘偏强，主动买入净额198.4亿元；但ETF份额对应资金大幅净流出48.3亿元，盘面买盘虽强，份额端却在逢高兑现，有资金借反弹离场。"))
